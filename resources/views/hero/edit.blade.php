                    ...
                    <form action="{{ route('heros.update', $hero) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="border-2 border-gray-300 p-2 w-full" name="name"
                                id="name" value="{{ $hero->name }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="text-xl text-gray-600">Description
                                <span class="text-red-500">*</span></label></br>
                            <textarea class="border-2 border-gray-300 p-2 w-full" name="content">{{ $hero->content }}</textarea>
                        </div>
